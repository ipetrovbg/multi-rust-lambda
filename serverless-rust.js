...
class RustPlugin {
  constructor(serverless, options) {
    ...
    this.hooks = {
      "before:package:createDeploymentArtifacts": () => { console.log('createDeploymentArtifacts'); this.build() },
      "before:deploy:function:packageFunction": () => { console.log('packageFunction'); this.build() },
